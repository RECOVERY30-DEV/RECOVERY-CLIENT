...
import { useDialogFocusTrap } from '@/features/cashflow/ui/use-dialog-focus-trap'
import {
    ...
    <MobileScreen aria-label="상담 예약 화면" className="min-h-[1260px]" mode="document">
      ...
      <div className="px-6 pt-[102px] pb-[62px]">
        ...
        <section aria-labelledby="consultation-purpose-title" className="mt-5">
          ...
          <div aria-label="선택한 회복안" className="mt-3 flex flex-wrap gap-2">
        ...
        <div className="mt-5">
          ...
          >
            상담 전 메모 <span className="text-[12px] font-normal text-secondary-300">(선택)</span>
          </label>
          <Textarea
            className="mt-3"
        ...
        <Button className="mt-8 w-full" disabled={isCompleted} onClick={() => setIsCompleted(true)}>
