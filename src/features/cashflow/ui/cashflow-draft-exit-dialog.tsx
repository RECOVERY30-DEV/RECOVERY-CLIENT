    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-primary-200/50 px-6">
      ...
      >
        ...
        <div className="mt-5 grid grid-cols-2 gap-2">
          <button
            className="h-[42px] rounded-[8px] bg-neutral-400 px-[22px] py-2 typo-body-3 text-primary-blue-900 focus-visible:ring-2 focus-visible:ring-primary-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none"
            onClick={onContinue}
          ...
          <button
            className="h-[42px] rounded-[8px] bg-secondary-700 px-[22px] py-2 typo-body-3 text-base-white focus-visible:ring-2 focus-visible:ring-primary-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none"
            onClick={onDiscard}
            type="button"
          >
            초안 삭제 후 나가기
