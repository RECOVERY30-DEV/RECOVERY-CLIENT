...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 font-sans whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:ring-primary-blue-800 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        primary:
        ...
        text: 'border-b border-b-neutral-700 text-secondary-300 hover:border-b-secondary-400 hover:text-secondary-400 active:border-b-secondary-300 active:text-secondary-300 disabled:border-b-disabled-200 disabled:text-disabled-200',
      },
      size: {
